  ...
  en: {
    translation: {
      ...
      cart: 'Cart',
        ...
        queued: 'Queued',
        poor_connection: 'Poor connection—actions may be delayed',
        offline_notice: 'You’re offline. We’ll place your order when back online.',
        cached_menu_hint: 'You can still browse the cached menu.',
        retry: 'Retry',
      },
  },
  es: {
    translation: {
      ...
      cart: 'Carrito',
        ...
        queued: 'En cola',
        poor_connection: 'Conexión deficiente—las acciones pueden retrasarse',
        offline_notice: 'Estás sin conexión. Realizaremos tu pedido cuando vuelvas en línea.',
        cached_menu_hint: 'Aún puedes explorar el menú en caché.',
        retry: 'Reintentar',
      },
  },
};
